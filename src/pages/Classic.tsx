  ...
  return <>
    <section {...stylex.attrs(s.hero)}>
      ...
      <div {...stylex.attrs(s.heroContent)}>
        ...
        <p {...stylex.attrs(s.intro)}>The Annual Shenvalee Hackers Holiday Of Leisurely Exercise: one weekend, one Cup, decades of stories, and absolutely no Tour cards required.</p>
      </div>
    </section>
    ...
    <section {...stylex.attrs(s.section)}><div {...stylex.attrs(s.sectionInner)}>
      ...
      <p {...stylex.attrs(s.sectionLead)}>The format can change year to year. The structure does not: arrive, play a lot of golf, decide the Cup, tell the stories again.</p>
