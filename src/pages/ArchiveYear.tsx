...
const blank = (year: number): ArchiveYearType => ({ id: year, year, title: `${year} ASHHOLE Classic`, subtitle: null, status: 'Archive', heroImage: year === 2024 ? '/assets/archive/2024/group.jpg' : null, cupWinner: null, migWinner: null, rounds: [], pairings: [], photos: [] });
