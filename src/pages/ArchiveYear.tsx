...
const blank = (year: number): ArchiveYearType => ({ id: year, year, title: `${year} ASHHOLE Classic`, subtitle: null, status: 'Archive', heroImage: null, cupWinner: null, migWinner: null, rounds: [], pairings: [], field: [], photos: [] });
